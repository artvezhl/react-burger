...
const SET_USER_INFO_URL = 'https://norma.nomoreparties.space/api/auth/user';

export { LOGIN_URL, REGISTER_URL, LOGOUT_URL, TOKEN_URL, FORGOT_URL, RESET_URL, GET_USER_INFO_URL, SET_USER_INFO_URL };
